        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopUpEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PopUpTitle = table.Column<string>(type: "text", nullable: false),
                    PopUpContent = table.Column<string>(type: "text", nullable: false),
                    PopUpImageUrl = table.Column<string>(type: "text", nullable: false),
                    PopUpLinkUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Chronicle = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    Incidents = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 7, 4, 15, 40, 37, 428, DateTimeKind.Utc).AddTicks(6245), "Full Access", "Admin", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 7, 4, 15, 40, 37, 428, DateTimeKind.Utc).AddTicks(6262), "Team Management", "Delegate", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2026, 7, 4, 15, 40, 37, 428, DateTimeKind.Utc).AddTicks(6265), "Match Reporting", "Committee", null }
                });
